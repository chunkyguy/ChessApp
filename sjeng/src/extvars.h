...
extern bool_c captures, searching_pv, post, time_exit, time_failure;
...
extern bool_c is_analyzing;

extern char my_partner[STR_BUFF];
extern bool_c have_partner;
extern bool_c must_sit;
extern int must_go;
extern bool_c go_fast;
extern bool_c piecedead;
extern bool_c partnerdead;
