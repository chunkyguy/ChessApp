...
void CheckBadFlow(bool_c reset)
{
	...
	if (!holding[!white_to_move][(white_to_move ? wpawn : bpawn)])
    {
		...
		for(i = 0; (i < his_num_moves) && (pawnmates == FALSE_C); i++)
		{
			make(&hismoves[0], i);
			...
			if (check_legal(&hismoves[0], i, ic))
			{
				...
				for (j = 0; (j < our_num_moves) && (pawnmates != FALSE_C); j++)
				{
	...
	if (!holding[!white_to_move][(white_to_move ? wknight : bknight)])
    {
		...
		for(i = 0; (i < his_num_moves) && (knightmates == FALSE_C); i++)
		{
			...
			if (check_legal(&hismoves[0], i, ic))
			{
				...
				for (j = 0; (j < our_num_moves) && (knightmates != FALSE_C); j++)
				{
					make(&ourmoves[0], j);
    ...
    {      
		...
		for(i = 0; (i < his_num_moves) && (bishopmates == FALSE_C); i++)
		{
			make(&hismoves[0], i);
			...
			if (check_legal(&hismoves[0], i, ic))
			{
				...
				for (j = 0; (j < our_num_moves) && (bishopmates != FALSE_C); j++)
				{
					make(&ourmoves[0], j);
	...
	if (!holding[!white_to_move][(white_to_move ? wrook : brook)])
    {
		...
		for(i = 0; (i < his_num_moves) && (rookmates == FALSE_C); i++)
		{
			make(&hismoves[0], i);
			...
			if (check_legal(&hismoves[0], i, ic))
			{
				...
				for (j = 0; (j < our_num_moves) && (rookmates != FALSE_C); j++)
				{
					make(&ourmoves[0], j);
	...
	if (!holding[!white_to_move][(white_to_move ? wqueen : bqueen)])
    {
		...
		for(i = 0; (i < his_num_moves) && (queenmates == FALSE_C); i++)
		{
			make(&hismoves[0], i);
			...
			if (check_legal(&hismoves[0], i, ic))
			{
				...
				for (j = 0; (j < our_num_moves) && (queenmates != FALSE_C); j++)
				{
					make(&ourmoves[0], j);
